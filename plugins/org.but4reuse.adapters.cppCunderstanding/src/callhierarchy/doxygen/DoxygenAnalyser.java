...
import callhierarchy.dot.DOTParser;
import callhierarchy.dot.DotElement;
...
public class DoxygenAnalyser {
	...
	public DoxygenAnalyser(File cppSourceFolder, Map<String, CppElement> elementsMap) {
		...
		doxygenBinaryLocation = activator.Activator.getDefault().getPreferenceStore()
				.getString(CppCunderstandingPreferencePage.DOXYGEN_PATH);
	}
