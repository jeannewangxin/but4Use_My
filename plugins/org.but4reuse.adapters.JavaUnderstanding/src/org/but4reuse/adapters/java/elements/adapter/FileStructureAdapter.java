...
import org.but4reuse.adapters.java.elements.FileElement;
import org.but4reuse.adapters.java.elements.FolderElement;
...
public class FileStructureAdapter implements IAdapter {
	...
	private void adapt(File file, List<IElement> elements, IElement container) {
		...
		boolean selectIgnorePath = Activator.getDefault().getPreferenceStore()
		...
		if (!selectIgnorePath && container != null) {
