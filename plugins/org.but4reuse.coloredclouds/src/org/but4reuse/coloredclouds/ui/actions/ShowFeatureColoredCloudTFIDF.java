package org.but4reuse.coloredclouds.ui.actions;
...
public class ShowFeatureColoredCloudTFIDF implements IObjectActionDelegate {
				...
				if (feat instanceof Feature) {
					...
					if (list == null) {
						...
						for (Feature f : fList.getOwnedFeatures()) {
							list.add(FeatureColoredCloudUtil.getFeatureWords(f));
						}
					}
